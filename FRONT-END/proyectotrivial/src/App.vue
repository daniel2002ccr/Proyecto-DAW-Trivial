  ...
  export default {
    computed: {
      navClass() {
        ...
        if (currentRoute === '/ranking' || currentRoute === '/registrar' || currentRoute === '/login'|| currentRoute === '/seleccion-dificultad' || currentRoute === '/easy' || currentRoute === '/medium' || currentRoute === '/hard') {
          return 'nav-seccion';
        }
      }
    }
